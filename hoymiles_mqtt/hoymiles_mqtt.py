...
def _parse_args() -> argparse.Namespace:
    ...
    cfg_parser.add(
        ...
        help='If true then datailed microinverter date will not be send to MQTT broker',
    )
...
if __name__ == '__main__':
    ...
    modbus_client = HoymilesModbusTCP(
        host=options.dtu_host, port=options.dtu_port, microinverter_type=microinverter_type
    )
    ...
    query_job = _HoymilesQueryJob(mqtt_builder=mqtt_builder, mqtt_publisher=mqtt_publisher, modbus_client=modbus_client)
